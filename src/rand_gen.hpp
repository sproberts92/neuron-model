...
// Need to specialise becuase we use different distributions for ints and
// floats/doubles. This could probably also be generalised for different
// distributions entirely, eg gaussian.
template<>
...
template <typename T>
void rand_gen<T>::seed_gen(void)
{
	auto timePoint = std::chrono::system_clock::now();
	auto init_seed = static_cast<rType::result_type>(
